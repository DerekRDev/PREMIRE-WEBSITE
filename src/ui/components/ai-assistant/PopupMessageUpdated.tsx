...
import { ChoiceSelectorUpdated } from './ChoiceSelectorUpdated';
...
export const PopupMessageUpdated: React.FC<PopupMessageProps> = ({
  ...
  return (
    <div 
      className={`fixed z-50 ${positionClasses[position]} transition-opacity duration-300 opacity-100 max-w-lg w-full mx-4`}
      role="alert"
    >
      <div className={`${typeClasses[type]} rounded-lg shadow-lg border p-4`}>
